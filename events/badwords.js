...
client.on("messageCreate", async (message) => {
  ...
  const arr2 = [
    "ass-fucker", "assfucker", "assfukka", "bellend",
    "boiolas", 
    "buceta", "bugger", "bunny fucker", "cawk", "chink", "cipa", "cuntlick", "cuntlicker", "cuntlicking", "cyalis",
    "dirsa", "dog-fucker",
    "donkeyribber", "doosh", "duche", "dyke", "fag", "fagging",
    "faggitt", "faggot", "faggs", "fagot", "fagots", "fags", "fanny", "fannyflaps", "fannyfucker",
    "fanyy", "fecker", "felching",
    "flange", 
    "gaylord", "gaysex", "goatse", "hoar", "hoare", "hoer", "hore",
    "kawk",
    "kunilingus",

    "n1gga",
    "n1gger", "nazi", "nigg3r", "nigg4h", "nigga", "niggah", "niggas", "niggaz",
    "nigger", "niggers", "nutsack",
    "pigfucker",
    "pimpis", "pissflaps", "rimjaw",
